  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="p-6 border-b border-slate-700 flex items-center justify-between bg-gradient-to-r from-blue-900/20 to-emerald-900/20">
            <div>
                  ...
                  <div className="space-y-6">
                    ...
                    {!isCreating && !editingItem && (
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3"
                      >
                        <FaPlus />
                        Add New Project
                      </button>
                      ...
                      <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 bg-slate-900 border border-slate-600 rounded-xl text-white focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20"
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              <input
                                ...
                                className="w-full px-4 py-3 bg-slate-900 border border-slate-600 rounded-xl text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-blue-600 file:text-white hover:file:bg-blue-500 file:cursor-pointer focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20"
                              />
                          ...
                          <div>
                            <label className="flex items-center gap-3 text-slate-400 cursor-pointer">
                              <input
                                ...
                                className="w-5 h-5 text-blue-600 bg-slate-900 border-slate-600 rounded focus:ring-2 focus:ring-blue-400/20"
                              />
                        ...
                        <div className="flex gap-4 mt-6">
                          <button
                            ...
                            className="flex-1 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3"
                          >
                            <FaSave />
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {projects.map((project) => (
                        <div
                          key={project.id}
                          className="bg-slate-800 rounded-2xl p-6 border border-slate-700 hover:border-blue-400/50 transition-all duration-300"
                        >
                          <div className="flex gap-6">
                            <img
                              ...
                              onError={(e) =>
                                (e.target.src =
                                  "https://via.placeholder.com/128?text=Project")
                              }
                            />
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
                          ...
                          <div>
                            ...
                            <div className="space-y-4">
                              ...
                              <p className="text-xs text-slate-500">
                                You can select multiple files to create a
                                carousel.
                              </p>
                              ...
                              <div className="flex gap-2">
                                <input
                                  ...
                                  id="manual-url-input"
                                  className="flex-1 px-4 py-2 bg-slate-900 border border-slate-600 rounded-lg text-sm text-slate-300 focus:border-blue-400"
                                />
                                <button
                                  type="button"
                                  onClick={() => {
                              ...
                              {/* Preview List */}
                              {galleryForm.media_urls &&
                                galleryForm.media_urls.length > 0 && (
                                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-4">
                                    {galleryForm.media_urls.map(
                                      (url, index) => (
                                        <div
                                          key={index}
                                          className="relative group rounded-lg overflow-hidden border border-slate-700 bg-black/50 aspect-video flex items-center justify-center"
                                        >
                                          {galleryForm.type === "video" ? (
                                            <video
                                              src={url}
                        ...
                        <div className="flex gap-4 mt-6">
                          <button
                            ...
                            className={`flex-1 bg-gradient-to-r from-blue-600 to-emerald-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 ${uploadingFile ? "opacity-50 cursor-not-allowed" : "hover:from-blue-500 hover:to-emerald-500"}`}
                          >
                            <FaSave />
                            {uploadingFile
                              ? "Uploading Media..."
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {gallery.map((item) => (
                        <div
                          key={item.id}
                          className="bg-slate-800 rounded-2xl p-4 border border-slate-700 hover:border-blue-400/50 transition-all duration-300 group"
                        >
                    ...
                    {(isCreating || editingItem?.type === "certificate") && (
                      <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
                          ...
                          <div>
                            ...
                            <div className="space-y-2">
                              ...
                              {certificateForm.credential_url && (
                                <div className="flex items-center gap-2">
                                  <a
                                    href={certificateForm.credential_url}
                                    target="_blank"
                                    rel="noopener noreferrer"
                        ...
                        <div className="flex gap-4 mt-6">
                          <button
                            onClick={
                              isCreating ? createCertificate : updateCertificate
                            }
                            className="flex-1 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3"
                          >
                            <FaSave />
                        ...
                        >
                          ...
                          {cert.credential_url && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-sm text-slate-400 hover:text-blue-400 flex items-center gap-1 mt-2"
                            >
                ...
                {activeTab === "messages" && (
                  <div className="space-y-4">
                    {messages.map((msg) => (
                      <div
                        key={msg.id}
                        className={`bg-slate-800 rounded-2xl p-6 border transition-all duration-300 ${
                          msg.status === "unread"
                    ...
                    {comments.map((comment) => (
                      <div
                        ...
                        className={`rounded-2xl p-6 border transition-all duration-300 ${
                          comment.is_pinned
                            ? "bg-gradient-to-br from-blue-900/30 to-blue-900/30 border-blue-400/50 shadow-lg"
                      ...
                      >
                        ...
                        <div className="flex gap-4">
                          <img
                            src={
                              comment.photo_url ||
                              `https://ui-avatars.com/api/?name=${encodeURIComponent(comment.name)}&background=00ffdc&color=000754&size=100`
                            }
                            alt={comment.name}
