...
export const StaggeredMenu = ({
  position = "right",
  colors = ["#0891b2", "#06b6d4"], // blue/Teal defaults to match site
  items = [],
  socialItems = [],
  displaySocials = true,
  displayItemNumbering = true,
  className,
  logoUrl = "/src/assets/images/Leologo.png", // Use site logo default
  menuButtonColor = "#fff",
  openMenuButtonColor = "#fff",
  changeMenuColorOnOpen = true,
  isFixed = false,
  accentColor = "#06b6d4", // blue accent
      ...
      >
        ...
        >
          <div className="flex justify-end mb-4">
            <button
              onClick={closeMenu}
              className={`text-3xl transition-colors ${theme === "dark" ? "text-white hover:text-blue-400" : "text-slate-800 hover:text-blue-500"}`}
            >
              &times;
            </button>
          </div>
                    ...
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        className={`sm-socials-link text-[1.2rem] font-medium no-underline relative inline-block py-[2px] transition-[color,opacity] duration-300 ease-linear
                                                    ${theme === "dark" ? "text-slate-300 hover:text-[#00ffdc]" : "text-[#111] hover:text-blue-600"}`}
                      >
                        {s.label}
                      </a>
                    </li>
