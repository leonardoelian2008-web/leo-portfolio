    ...
    if (lockoutTime) {
      const updateTimer = () => {
        const remaining = Math.max(
          0,
          Math.ceil((lockoutTime - new Date().getTime()) / 1000),
        );
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group">
              <div className="relative">
                <FaUser className="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-400 group-focus-within:text-blue-400 transition-colors duration-300" />
                <input
                  type="text"
            ...
            <div className="group">
              <div className="relative">
                <FaLock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-400 group-focus-within:text-blue-400 transition-colors duration-300" />
                <input
                ...
                <button
                  ...
                  disabled={isLocked}
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-blue-400 transition-colors duration-300 disabled:opacity-50"
                >
                ...
                >
                  ...
                  <div className="text-orange-300 text-sm">
                    ...
                    <p className="font-mono">
                      ...
                      {String(lockoutTimer % 60).padStart(2, "0")}
                    </p>
                  </div>
                </motion.div>
              )}
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 shadow-lg hover:shadow-blue-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
