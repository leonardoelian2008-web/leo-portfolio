      ...
      <div className="text-center py-12">
        <div className="inline-block p-8 bg-slate-800/30 border border-slate-700/50 rounded-2xl">
          ...
          <p className="text-slate-500 text-sm mt-2">
            Add certificates in your Supabase database!
          </p>
        </div>
      </div>
    );
          ...
          <AnimatePresence>
            {certificates.slice(0, visibleCount).map((cert, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/0 via-transparent to-blue-500/0 group-hover:from-emerald-500/5 group-hover:to-blue-500/5 transition-all duration-500 pointer-events-none rounded-2xl"></div>
              </motion.div>
            ))}
          </AnimatePresence>
        </div>
          ...
          <div className="flex justify-center mt-12">
            {visibleCount < certificates.length ? (
              <motion.button
                ...
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-semibold rounded-full transition-all duration-300 shadow-lg hover:shadow-blue-500/25"
              ...
              <div className="p-8">
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="px-4 py-2 bg-blue-500/20 rounded-full text-blue-300 font-semibold border border-blue-400/30">
                      {previewCert.issuer}
                    </span>
                ...
                {previewCert.credential_url && (
                  <div className="flex justify-center">
                    <a
                      ...
                      className="group px-8 py-3 bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-500 hover:to-emerald-500 text-white font-semibold rounded-full transition-all duration-300 flex items-center gap-3 shadow-lg hover:shadow-blue-500/25"
                    >
